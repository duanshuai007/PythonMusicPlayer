...
from PyQt5.QtWidgets import QFileDialog, QMenu, QAction#, QMainWindow
...
在电脑中安装LAVFilters以支持多种格式文件
LAVFilters-0.76.1-Installer.exe: https://github.com/Nevcairiel/LAVFilters/releases?page=1
...
class Window(QtWidgets.QMainWindow, Ui_qt5player):
    ...
    def __ButtonPlayModeFunction(self):
        self.logger.info("__ButtonPlayModeFunction:{}".format(self.__playmode))
        if self.__playmode == self.__PLAY_RANDOM_MODE:
